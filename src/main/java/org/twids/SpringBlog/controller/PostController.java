...
public class PostController {
    ...
    //@PreAuthorize notasyonu, Spring Security'de bir metodun belirli bir koşul 
    //sağlandığında erişilebileceğini belirtmek için kullanılır. Yani, oturum açmış ise.
